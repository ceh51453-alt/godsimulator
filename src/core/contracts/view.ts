...
export const MUC_RO = ['ro', 'mo', 'tin_don', 'mu'] as const;
...
export type ProjectedStoryline = Readonly<{
  ...
  nhanVat: readonly Readonly<{ entityId: string; ten: string; vaiTro: string }>[];
  kyUcMach: string;
...
export const NHIP_THOI_GIAN = ['nhat', 'nien', 'the_dai', 'vinh_kiep'] as const;

...
export const CHE_DO_HO_SO = ['nhanh', 'goi_y', 'day_du', 'bo_qua'] as const;
...
export function hoSoToiThieu(id: string, now: number): PlayerProfile {
...
export function danhTinhTrong(id: string, saveId: string): CreatorIdentity {

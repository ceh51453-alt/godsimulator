...
export const NHAN_NGUON_SINH: Readonly<Record<NguonSinh, string>> = Object.freeze({
...
export const NHOM_NGUON: Readonly<Record<string, readonly NguonSinh[]>> = Object.freeze({
  do_ta: Object.freeze(['nguoi_choi'] as const),
  do_nguoi_khac: Object.freeze(['than', 'pham_nhan'] as const),
  tu_sinh: Object.freeze(['the_gioi_tu_sinh', 'workflow'] as const),
  ket_tinh: Object.freeze(['ket_tinh', 'chuyen_hoa'] as const),
});
 ...
 */
export function docNguonGoc(aspects: Readonly<Record<string, unknown>>): Provenance {
...
export function nguonGoc(
  nguon: NguonSinh,
  tick: number,
  them: { actorId?: string | null; eventId?: string | null; parentIds?: readonly string[] } = {},
): Provenance {

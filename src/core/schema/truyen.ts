...
export const VAI_TRO_MACH = ['chinh', 'doi_dau', 'xuc_tac', 'chung_kien', 'nan_nhan', 'ke_thua'] as const;
...
export function machDaDong(gd: GiaiDoanMach): boolean {
...
export const LOAI_PHUC_BUT = ['vat', 'loi_noi', 'nhan_vat', 'dieu_bao', 'bi_mat', 'mon_no'] as const;
...
export function quaHan(f: Foreshadow, tick: number): boolean {
...
export const ONG_KINH_MAC_DINH: Lens = LensSchema.parse({});

...
export const ENTITIES_FIXTURE: readonly Entity[] = [
  LUAT_MAU,
  KHAI_NIEM_O_UE,
...
const l = (id: string, tuId: string, denId: string, quanHe: string, trongSo = 60): Link =>
  LinkSchema.parse({ id, branchId: BRANCH_GOC, tuId, denId, quanHe, trongSo, tickTao: 0 });

/** [BB] Phần 6.3 quy tắc 3 — không thực thể nào có _degree === 0. */
export const LINKS_FIXTURE: readonly Link[] = [
...
export const WORLD_FIXTURE: World = WorldSchema.parse({
  id: 'world_fixture',
  branchId: BRANCH_GOC,
  seed: SEED_FIXTURE,
  tick: 120,

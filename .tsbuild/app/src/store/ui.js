...
export const TEN_MAN_HINH = Object.freeze({
...
export const useUi = create((set, get) => ({
    ...
    async napTuDia(saveId, branchId) {
        ...
        try {
            ...
            set({
                ...
                tab: hang?.tabThongTin ?? 'tong_quan',
    ...
    ghimThienTuong(khoa) {
        ...
        if (anh === null || anh.ghim.includes(khoa))
            return;

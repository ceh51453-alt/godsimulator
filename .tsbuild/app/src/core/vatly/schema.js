 ...
 */
export const PHU_THUOC_TRUC = Object.freeze({
    khong_gian: Object.freeze([]),
    thoi_gian: Object.freeze([]),
    nhan_qua: Object.freeze(['khong_gian', 'thoi_gian']),
    danh_tinh: Object.freeze([]),
    sinh_tu: Object.freeze(['danh_tinh']),
    nhan_thuc: Object.freeze(['danh_tinh']),
    van_menh: Object.freeze(['thoi_gian', 'nhan_qua']),
});
/** Tham số mặc định PHÀM TỤC của từng trục — dùng khi trục còn `vo_danh` (43.7). */
export const THAM_SO_MAC_DINH = Object.freeze({
    khong_gian: Object.freeze({
        toPo: 'mat_phang',
        khoangCach: 'do_luong',
        coTheGap: false,
...
export const KHAI_NIEM_NEN_CUA_TRUC = Object.freeze({
    khong_gian: Object.freeze(['noi_chon', 'khoang_cach']),
    thoi_gian: Object.freeze(['truoc_sau', 'bien_doi']),
    nhan_qua: Object.freeze(['nguyen_nhan', 'hau_qua']),
    danh_tinh: Object.freeze(['ban_nga', 'cung_mot']),
    sinh_tu: Object.freeze(['cai_chet']),
    nhan_thuc: Object.freeze(['biet', 'bi_an']),
    van_menh: Object.freeze(['tat_yeu']),
});
export const SubstrateLawSchema = z
    ...
    .strict();
// ─────────────────────────────────────────── cơ chế phái sinh
export const CO_CHE_DUNG_SAN = ['than_bi', 'nguyen_diem', 'co_huu_ket_gioi', 'vu_khi_khai_niem'];
/**

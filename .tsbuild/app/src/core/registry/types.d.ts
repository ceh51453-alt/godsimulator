...
export declare const MAU_KIND: readonly ["dong", "ngoc", "van", "hoi", "lam", "tro"];
...
export type VerbDef = BaseDef & {
     ...
     */
    readonly kiemTraTruoc?: (ctx: VerbCtx) => KetQua<null> | {
        ok: false;
        chan: BlockReason;
    };
...
export declare const PHAM_VI_TIEN_TRINH: readonly ["entity", "household", "place", "region", "world"];
export type PhamViTienTrinh = (typeof PHAM_VI_TIEN_TRINH)[number];
export declare const DON_VI_NHIP: readonly ["tick", "day", "week", "season", "year", "era", "event"];
export type DonViNhip = (typeof DON_VI_NHIP)[number];
/** Phần 71.3 — ba độ phân giải, cộng `adaptive` để engine tự chọn theo ống kính. */
export declare const DO_PHAN_GIAI: readonly ["micro", "meso", "macro", "adaptive"];

...
import { z } from 'zod';
// ─────────────────────────────────────────── lịch (50.4)
export const CHE_DO_LICH = ['moi_luot', 'theo_luot', 'theo_thoi_gian_truyen', 'theo_su_kien'];
export const DON_VI_THOI_GIAN = ['gio', 'ngay', 'tuan', 'thang', 'nam', 'the_dai'];
...
export const TaskContextSchema = z
    ...
    .prefault({});
// ─────────────────────────────────────────── đích ghi (50.7)
export const LOAI_DICH_GHI = ['chen_vao_canh', 'bien_theo_luot', 'ghi_lorebook', 'patch_world'];
 ...
 */
export const JSON_PATCH_OPS = ['replace', 'delta', 'insert', 'remove', 'move'];

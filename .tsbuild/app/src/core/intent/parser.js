...
const DAU_HIEU_BI_MAT = ['bi mat', 'len len', 'giau', 'khong ai biet', 'am tham'];
const DAU_HIEU_TRANH_HAI = ['khong lam hai', 'khong giet', 'nhe nhang', 'tranh do mau'];
const DAU_HIEU_CHAP_HAI = ['bang moi gia', 'du phai', 'giet', 'pha huy', 'thieu rui'];
/**
 ...
 */
export function timMucTieu(cau, view) {
    const s = boDau(cau);
    const ra = [];
    const daCo = new Set();
 ...
 */
export function parseIntent(rawText, ts) {
...
export function suaIntent(goc, sua) {
    return IntentSchema.parse({
        ...goc,
        ...sua,
...
export function refDoanDuoc(rawText) {
...
export function laDauHieuProject(rawText) {

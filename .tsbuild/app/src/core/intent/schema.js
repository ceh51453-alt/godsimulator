 ...
 */
import { z } from 'zod';
import { EntityRefSchema, BlockReasonSchema, ExprNodeSchema, PatchTemplateSchema, ViewModeSchema, } from '../contracts/primitives.js';
export const HORIZON = ['immediate', 'scene', 'day', 'season', 'year', 'era'];
...
export const ActionOutcomeSchema = z
    ...
    .strict();
export const PHAM_VI_PROJECT = ['personal', 'household', 'local', 'regional', 'divine', 'cosmic'];
 ...
 */
export const CAP_KET_TINH = ['personal', 'household', 'institution', 'culture', 'concept', 'law'];

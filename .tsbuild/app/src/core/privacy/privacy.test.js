...
import { PlayerProfileSchema, CreatorIdentitySchema, ProjectedPlayerPersonaSchema, StartingPresenceDraftSchema, hoSoToiThieu, danhTinhTrong, } from '../schema/player.js';
...
describe('ma trận riêng tư phủ hết schema', () => {
    ...
    it('[BB] không trường nào được phép đi vào world, lorebook, rag, export hay log', () => {
        const camTuyetDoi = ['world', 'lorebook', 'rag', 'export_mac_dinh', 'log'];
...
describe('không thu thập dữ liệu nhận diện — Phần 78.2 [BB]', () => {
    it.each(['email', 'birthday', 'dateOfBirth', 'gender', 'age', 'realName', 'phone'])('PlayerProfile không có trường %s', (truong) => {

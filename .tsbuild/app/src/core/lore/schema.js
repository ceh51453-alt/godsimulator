 ...
 */
import { z } from 'zod';
export const NGUON_LOREBOOK = ['nguoi_dung', 'tu_sinh', 'di_san'];
/**
 * Dải `order` — 51.5 [BB].
 *
...
export function daiCuaNguon(nguon) {
...
export const LorebookEntrySchema = z
    ...
    .strict();
export const CONFLICT_POLICY = ['dung_hop', 'song_song', 'tranh_doat'];
export const LorebookSchema = z
    ...
    .strict();
// ─────────────────────────────────────────── kỳ vọng và dị bản
export const LOAI_KY_VONG = ['ton_tai', 'quan_he', 'su_kien', 'quy_luat', 'ket_cuc', 'tinh_cach'];
export const TRANG_THAI_KY_VONG = ['cho', 'da_thoa', 'da_lech', 'bat_kha'];
/**

...
export const CHE_DO_BENCHMARK = ['heuristic', 'semantic', 'fusion'];
export const KET_LUAN = ['tot_hon', 'ngang_bang', 'te_hon', 'khong_dung_duoc'];
/**
 ...
 */
export function ketLuan(baseline, moi, ndcgMucTieu) {
    ...
    if (moi.tongKet.forbiddenRecall > 0) {
        return {
            ...
            deltaNdcg: dNdcg,
            deltaRecall: dRecall,
            thongDiep: `Mode "${moi.mode}" để lọt chunk cấm (forbiddenRecall = ${moi.tongKet.forbiddenRecall}). ` +
    ...
    if (dNdcg < 1e-4) {
        return {
            ...
            deltaNdcg: dNdcg,
            deltaRecall: dRecall,
            thongDiep: `nDCG@10 ngang baseline. Semantic không sai, nhưng cũng chưa đáng tiền: ` +
 ...
 */
export function soSanhPhien(cu, moi) {

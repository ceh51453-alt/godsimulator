...
export const LY_DO_CHON = ['semantic', 'graph', 'precedent', 'trust', 'recency', 'diversity'];
...
export const CAU_HINH_HEURISTIC = RerankConfigSchema.parse({
    bat: true,
 ...
 */
export function doCauHinhRerank(input) {

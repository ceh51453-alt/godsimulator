...
import { z } from 'zod';
// ─────────────────────────────────────────── lời cầu (Phần 22.1)
export const LOAI_CAU = ['xin_cuu', 'ta_on', 'nguyen_rua', 'hoi_dap', 'dang_hien', 'thach_thuc'];
/**
 ...
 */
export const CACH_TRA_LOI = ['chua', 'ban_phuoc', 'lam_ngo', 'trung_phat', 'dau_hieu', 'tra_gia'];
...
export const HAU_QUA_TRA_LOI = Object.freeze({
 ...
 */
export function giaoUocCanBang(g) {

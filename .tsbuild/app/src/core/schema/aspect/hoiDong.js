...
export const VAI_HOI_DONG = ['chu_tich', 'thanh_vien', 'khach', 'bi_truc_xuat'];
export const NHAN_VAI_HOI_DONG = Object.freeze({
 ...
 */
export const LUAT_KE_VI = ['bau_phieu', 'huyet_thong', 'manh_nhat', 'chi_dinh', 'khong_co'];
 ...
 */
export function demPhieu(hd, nq) {
    const cuTri = hd.ghe.filter(coPhieu);
    if (cuTri.length === 0)
        return 'khong_du_phieu';
    let thuan = 0;
    let chong = 0;
    let daBo = 0;

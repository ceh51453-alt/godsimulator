...
export const LANE_ORDER = Object.freeze(Object.fromEntries(MODULE_LANES.map((l, i) => [l, i])));
...
export const TARGET_PIPELINES = ['narrator', 'updater', 'evolution', 'workflow_task'];
...
export const QuarantinedScriptSchema = z
    ...
    .strict();
export const SCRIPT_ADAPTER_KINDS = ['cot_cleanup', 'prompt_merge', 'scene_switch', 'choice_ui'];
/**

...
export function KhoiNguyen({ onQuayLai } = {}) {
    ...
    return (_jsxs("main", { style: { maxWidth: 720, margin: '0 auto', padding: '56px 20px 80px' }, children: [onQuayLai !== undefined && (_jsx("button", { style: { ...nutChung(false), marginBottom: 18 }, onClick: onQuayLai, children: "Quay l\u1EA1i S\u1EA3nh V\u00E0o" })), _jsx("p", { style: { color: 'var(--chu-3)', margin: 0, letterSpacing: '0.12em', fontSize: 12 }, children: "THI\u00CAN DI\u1EC4N" }), _jsx("h1", { style: { fontSize: 32, margin: '6px 0 8px', fontWeight: 600 }, children: "Kh\u1EDFi Nguy\u00EAn" }), _jsx("p", { style: { color: 'var(--chu-2)', marginTop: 0 }, children: "Th\u1EBF gi\u1EDBi m\u1EDF ra r\u1ED7ng: kh\u00F4ng \u0111\u1EA5t, kh\u00F4ng lu\u1EADt, kh\u00F4ng th\u1EA7n, kh\u00F4ng ng\u01B0\u1EDDi. M\u1ECDi th\u1EE9 ch\u1EC9 t\u1ED3n t\u1EA1i sau khi \u0111\u01B0\u1EE3c k\u1EC3 ra trong l\u00FAc ch\u01A1i." }), _jsx(Muc, { id: "h-chedo", ten: "B\u1EA1n mu\u1ED1n khai bao nhi\u00EAu", children: _jsx("div", { role: "radiogroup", "aria-labelledby": "h-chedo", style: { display: 'grid', gap: 8 }, children: CHE_DO.map((c) => (_jsxs("label", { style: {
                            display: 'flex',
                            gap: 10,
